...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="row">
                <div class="card bg-dark text-center pt-3 col mx-2" style="width: 18rem;">
                    <img
                ...
                <div class="card bg-dark text-center pt-3 col mx-2" style="width: 18rem;">
                    ...
                    <div class="card-body">
                        ...
                        <a href="vistas/empleados.jsp" class="btn btn-success fw-bold text-white">Go to Empleado</a>
                    </div>
                </div>
                <div class="card bg-dark text-center pt-3 col mx-2" style="width: 18rem;">
                    <img
